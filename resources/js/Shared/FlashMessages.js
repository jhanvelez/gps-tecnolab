...
export default () => {
  ...
  const styleBoxContentAlerts = {
    width: '100%',
    padding: '0 0 0 1em'
  }

  return (
    <div style={styleBoxContentAlerts} className='d-flex justify-content-end'>
      {flash.success && visible && (
        <Alert style={styleBoxAlert} variant="success" onClose={() => setShow(false)} dismissible>
      ...
      {(flash.error || numOfErrors > 0) && visible && (
        <Alert style={styleBoxAlert} variant="danger" onClose={() => setShow(false)} dismissible>
